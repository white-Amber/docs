...
![第3阶段：Java高级应用-第18章](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/%E7%AC%AC3%E9%98%B6%E6%AE%B5%EF%BC%9AJava%E9%AB%98%E7%BA%A7%E5%BA%94%E7%94%A8-%E7%AC%AC18%E7%AB%A0.png)
...
![4428b288361296048](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/4428b288361296048.png)

### 1.4 各版本介绍

![jdkxintexing](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/jdkxintexing.jpg)
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224400400-image-20220525200441935.png" alt="image-20220525200441935" style="zoom:80%;" />
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224607364-image-20220525201653599.png" alt="image-20220525201653599" style="zoom:80%;" />
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224658891-image-20220527101737072.png" alt="image-20220527101737072" style="zoom:67%;" />

- 从匿名类到 Lambda 的转换举例2

<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224707247-image-20220527101814203.png" alt="image-20220527101814203" style="zoom:80%;" />
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224732422-image-20220527103215741.png" alt="image-20220527103215741" style="zoom:67%;" />
...
![](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224813887-03-Overview.png)
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224823621-image-20220527111442115.png" alt="image-20220527111442115" style="zoom: 80%;" />

举例2：

<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224830627-image-20220527111621424.png" alt="image-20220527111621424" style="zoom:80%;" />

作为参数传递 Lambda 表达式：

<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224838599-image-20220527111751485.png" alt="image-20220527111751485" style="zoom:80%;" />
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/20240818224959114-image-20220514180803311.png" alt="image-20220514180803311" style="zoom: 50%;" />
...
Stream流相较于传统iterable的性能如何？

* 在数据量小的时候，iterable性能好于Stream。在数据量大的时候iterable性能差于Stream，尤其是Parallel Stream。
* 在数据量小的时候，处理这些任务所花费的时间是毫秒级，所以为了代码的简介性可以**不考虑这点性能**。

> 参考链接：
>
> [Java8 Stream 数据流，大数据量下的性能效率怎么样？-阿里云开发者社区](https://developer.aliyun.com/article/862129#:~:text=1 在少低数据量的处理场景中（size<%3D1000），stream 的处理效率是不如传统的 iterator 外部迭代器处理速度快的，但是实际上这些处理任务本身运行时间都低于毫秒，这点效率的差距对普通业务几乎没有影响，反而 stream 可以使得代码更加简洁； 2,的处理效率会高于 iterator，特别是使用了并行流，在cpu恰好将线程分配到多个核心的条件下（当然parallel stream 底层使用的是 JVM 的 ForkJoinPool，这东西分配线程本身就很玄学），可以达到一个很高的运行效率，然而实际普通业务一般不会有需要迭代高于10000次的计算； 更多项目)
