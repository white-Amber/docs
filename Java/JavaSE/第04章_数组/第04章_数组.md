...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/第1阶段：Java基本语法-第05章.png" alt="第1阶段：Java基本语法-第05章" style="zoom:45%;" />
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/snipaste_20220317_000101.jpg" alt="snipaste_20220317_000101" style="zoom: 50%;" />
...
![image-20220317000952499](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220317000952499.png)
...
![image-20211221164709624](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20211221164709624.png)
...
public class ArrayTest2 {
    public static void main(String[] args) {
        ...
        int[] nums;
        nums = new int[]{10,20,30,40}; //声明和初始化在两个语句完成，就必须使用new int[]
...
![](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1561509460135.png)
...
为了提高运算效率，将内存划分为不同的区域，每片区域有自己特有的数据处理方式和内存管理方式。

![JVM架构-简图](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/JVM架构-简图.png)
...
![](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/数组内存图1.jpg)
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/数组内存图2.jpg" style="zoom:67%;" />
...
```
 ...
 <img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/数组内存图3.jpg" style="zoom:67%;" />
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220317004637748.png" alt="image-20220317004637748" style="zoom:80%;" />
...
- 如果说可以把一维数组当成几何中的`线性图形`，那么二维数组就相当于是`一个表格`，像Excel中的表格、围棋棋盘一样。
  ...
  <img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220317004810263.png" alt="image-20220317004810263" style="zoom:80%;" />
...
```
  ...
  ![image-20220516095701345](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220516095701345.png)

蓝框的几个元素，可以使用一维数组来存储。但现在发现每个元素下还有下拉框，其内部还有元素，那就需要使用二维数组来存储：

  ![image-20220516095829526](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220516095829526.png)

- 使用说明

  ![1561524724397](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1561524724397-1647707344971.png)
...
![1562112672215](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1562112672215.png)
...
![1562113179785](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1562113179785.png)
...
![1562113981079](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1562113981079.png)
...
![image-20220317005436209](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220317005436209.png)
...
![image-20220317005549522](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220317005549522.png)
...
![1574577970893](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1574577970893.png)
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/snipaste_20220317_225346.jpg" alt="snipaste_20220317_225346" style="zoom:80%;" />![snipaste_20220317_225359](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/snipaste_20220317_225359.jpg)
...
![1659199523932](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1659199523932.png)
...
<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20221117195931777.png" alt="image-20221117195931777" style="zoom:67%;" />
...
![1561469087319](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1561469087319.png)
...
![image-20220317230955644](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220317230955644.png)

实现步骤：

<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220623210601915.png" alt="image-20220623210601915" style="zoom:67%;" />
...
- **衡量排序算法的优劣：**
  ...
  - `稳定性`：若两个记录A和B的关键字值相等，但排序后A、B的先后次序保持不变，则称这种排序算法是稳定的。
    ...
    ![image-20211222113701365](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20211222113701365.png)
...
![image-20211222111142684](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20211222111142684.png)
...
![image-20220824003440106](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220824003440106.png)

#### 6.6.3 冒泡排序（Bubble Sort）

<img src="https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220516094637228.png" alt="image-20220516094637228" style="zoom:67%;" />
...
![BubbleSort](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/BubbleSort.png)
...
![image-20220317235922776](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20220317235922776.png)

图示2：

第一轮操作：

![image-20221117205612230](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20221117205612230.png)

第二轮操作：

![image-20221117205719427](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/image-20221117205719427.png)
...
* `数组排序`
  ...
  * static void parallelSort(int[] a)：将a数组按照从小到大进行排序。**只有在数组元素大于8192或CPU核心数大于1时，才会走并行排序**。[Java中的 arrays parallelsort和sort到底谁快？](https://www.zhihu.com/question/327973538/answer/708441719)
...
* `使用生成器填充数组`
  ...
  * static void setAll(int[] array, IntUnaryOperator generator)：使用提供的generator来填充数组array。
  * static void parallelSetAll(int[] array, IntUnaryOperator generator)：使用提供的generator来**并行**填充数组array。

  ```java
  //举例：使用30-40的随机数填充数组arr
  int[] arr = new int[5];
  Arrays.setAll(arr, new IntUnaryOperator(){
      @Override
      public int applyAsInt(int operand) {
          return (int)(Math.random() * (40-30+1))+30;
      }
  });
...
* `将数组转换为List`
  ...
  * static <T> List<T> asList(T... a) ：将数组a转换为ArrayList。
...
![](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/数组越界异常.jpg)
...
![](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/空指针异常-1647708157677.jpg)

**空指针异常在内存图中的表现**

![1572338767825](https://cdn.jsdelivr.net/gh/white-Amber/blog-img/img/1572338767825-1647708157678.png)
